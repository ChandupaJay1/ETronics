...
public class Checkout extends HttpServlet {
    ...
    private void saveOrders(Session session, Transaction transaction, Address address, User user, JsonObject responseJsonObject) {
        ...
        try {
            ...
            Order_Status order_Status = (Order_Status) session.get(Order_Status.class, 1); //1 - paid
            ...
            //set payment data
            String merchant_id = "1226323";
            String formatedAmount = new DecimalFormat("0.00").format(amount);
            String currency = "LKR";
            String merchantSecret = PayHere.generateMD5("NDAwNDg1ODcyNDM0OTA2MDE2MjAwNTU1MTY3MTcwMDUxMjE2NQ==");
            ...
            payhere.addProperty("phone", "0701272338");
            payhere.addProperty("address", "Anuradhapura, Sri Lanka");
            payhere.addProperty("city", "Anuradhapura");
